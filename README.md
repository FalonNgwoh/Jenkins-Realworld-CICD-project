...
1) Create a GitHub Repository with the name `Jenkins-Realworld-CICD-Project` and push the code in this branch(main) to 
    ...
    - Download the code in in this repository `"Main branch"`: https://github.com/FalonNgwoh/Jenkins-Realworld-CICD-project.git
    ...
    ![ProjectRepositoryCode!](https://raw.githubusercontent.com/FalonNgwoh/Jenkins-Realworld-CICD-project/cf73b0fdd614457d058a659315915ad925c05d6e/Screenshot%202025-09-21%20192624.png)
